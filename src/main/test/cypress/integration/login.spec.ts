...
describe('Login', () => {
  ...
  it('Should load with correct initial state', () => {
    ...
    cy.getByTestId('email')
      .should('have.attr', 'title', 'Campo obrigátorio')
      .should('have.attr', 'readOnly')
    cy.getByTestId('email-label').should('have.attr', 'title', 'Campo obrigátorio')
    cy.getByTestId('password-wrap').should('have.attr', 'data-status', 'invalid')
    cy.getByTestId('password')
      .should('have.attr', 'title', 'Campo obrigátorio')
      .should('have.attr', 'readOnly')
    cy.getByTestId('password-label').should('have.attr', 'title', 'Campo obrigátorio')
  ...
  it('Should not call submit if not valid', () => {
    cy.route({
      method: 'POST',
      url: /login/,
      status: 200,
